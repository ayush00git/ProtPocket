...
/**
 * FragmentList — displays suggested fragment molecules from the ZINC database for a pocket.
 */
    ...
    <div className="flex flex-col gap-3">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-3">
        {fragments.map((frag, idx) => (
          ...
          >
            {/* Header: Name + ZINC link */}
            <div className="flex flex-col gap-0.5">
              <a
                href={`https://zinc20.docking.org/substances/${frag.zinc_id}/`}
                target="_blank"
              ...
              {frag.name && frag.name !== frag.zinc_id && (
