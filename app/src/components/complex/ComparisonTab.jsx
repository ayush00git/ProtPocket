...
export function ComparisonTab({ comparison, activePocketIdx, handleHighlight }) {
  ...
  return (
    <div className="flex flex-col gap-8 w-full mt-4">
      ...
      {/* 6. Fragment Comparison — ZINC novel compounds */}
      {fragment_comparison && (
        ...
        <div className="flex flex-col gap-5 mt-6">
          <div>
            <h4 className="font-display font-bold text-xl text-text-primary flex items-center gap-2">
              ...
              Novel ZINC Fragment Suggestions
            </h4>
            <p className="font-mono text-sm text-text-muted mt-1">
              Compounds from the ZINC database unique to the dimerized state — not suggested for any monomer pocket.
            </p>
          </div>
