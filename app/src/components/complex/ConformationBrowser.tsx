...
interface ConformationBrowserProps {
  conformations: Conformation[];
  activeMode: number | null;
  onSelect: (conformation: Conformation) => void;
}

export function ConformationBrowser({ conformations, activeMode, onSelect }: ConformationBrowserProps) {
