...
export function ViewerPlaceholder({ monomerUrl, complexUrl, monomerPlddt, dimerPlddt }: ViewerPlaceholderProps) {
  const renderPanel = (label: string, url: string | undefined, plddt: number | undefined, desc: string) => {
