...
import type { LeaderboardEntry, Conformation } from '../../types';

const CHEMBL_BASE_URL = 'https://www.ebi.ac.uk/chembl/compound_report_card/';

interface DockingLeaderboardProps {
 ...
 */
export function DockingLeaderboard({ entries, activeEntryId, onSelect, onRemove }: DockingLeaderboardProps) {
...
interface DockingResultDetailProps {
 ...
 */
export function DockingResultDetail({ entry, onConformationSelect }: DockingResultDetailProps) {
