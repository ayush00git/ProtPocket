          ...
          <div className="flex flex-col gap-4">
            {hasResults ? (
              ...
              <div className="flex flex-col items-center text-center py-16 gap-4">
                <span className="font-mono text-sm text-text-muted">No targets found matching "{query}"</span>
                <span className="text-text-secondary text-sm">Try adjusting your search terms or exploring the dashboard.</span>
              </div>
            )}
          </div>
        )}
